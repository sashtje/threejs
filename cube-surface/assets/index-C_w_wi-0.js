...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function Lc(){return new oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gl(),fragmentShader:`
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function Uc(){return new oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gl(),fragmentShader:`
	...
	`}function z_(r){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===mo||l===_o,h=l===Mr||l===Sr;if(c||h){let u=t.get(o);const f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Pc(r)),u=c?e.fromEquirectangular(o,u):e.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),u.texture;if(u!==void 0)return u.texture;{const m=o.image;return c&&m&&m.height>0||h&&m&&i(m)?(e===null&&(e=new Pc(r)),u=c?e.fromEquirectangular(o):e.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),o.addEventListener("dispose",s),u.texture):null}}}return o}function i(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function k_(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&qr("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function H_(r,t,e,n){const i={},s=new WeakMap;function a(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let d=0,p=_.length;d<p;d++)t.remove(_[d])}f.removeEventListener("dispose",a),delete i[f.id];const m=s.get(f);m&&(t.remove(m),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(u,f){return i[f.id]===!0||(f.addEventListener("dispose",a),i[f.id]=!0,e.memory.geometries++),f}function l(u){const f=u.attributes;for(const g in f)t.update(f[g],r.ARRAY_BUFFER);const m=u.morphAttributes;for(const g in m){const _=m[g];for(let d=0,p=_.length;d<p;d++)t.update(_[d],r.ARRAY_BUFFER)}}function c(u){const f=[],m=u.index,g=u.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let x=0,T=E.length;x<T;x+=3){const R=E[x+0],A=E[x+1],b=E[x+2];f.push(R,A,A,b,b,R)}}else if(g!==void 0){const E=g.array;_=g.version;for(let x=0,T=E.length/3-1;x<T;x+=3){const R=x+0,A=x+1,b=x+2;f.push(R,A,A,b,b,R)}}else return;const d=new(Ih(f)?kh:zh)(f,1);d.version=_;const p=s.get(u);p&&t.remove(p),s.set(u,d)}function h(u){const f=s.get(u);if(f){const m=u.index;m!==null&&f.version<m.version&&c(u)}else c(u);return s.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function G_(r,t,e){let n;function i(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,m){r.drawElements(n,m,s,f*a),e.update(m,n,1)}function c(f,m,g){g!==0&&(r.drawElementsInstanced(n,m,s,f*a,g),e.update(m,n,g))}function h(f,m,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,f,0,g);let d=0;for(let p=0;p<g;p++)d+=m[p];e.update(d,n,1)}function u(f,m,g,_){if(g===0)return;const d=t.get("WEBGL_multi_draw");if(d===null)for(let p=0;p<f.length;p++)c(f[p]/a,m[p],_[p]);else{d.multiDrawElementsInstancedWEBGL(n,m,0,s,f,0,_,0,g);let p=0;for(let E=0;E<g;E++)p+=m[E];for(let E=0;E<_.length;E++)e.update(p,n,_[E])}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function V_(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case r.TRIANGLES:e.triangles+=o*(s/3);break;case r.LINES:e.lines+=o*(s/2);break;case r.LINE_STRIP:e.lines+=o*(s-1);break;case r.LINE_LOOP:e.lines+=o*s;break;case r.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function W_(r,t,e){const n=new WeakMap,i=new Me;function s(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(o);if(f===void 0||f.count!==u){let S=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",S)};var m=S;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,d=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],E=o.morphAttributes.normal||[],x=o.morphAttributes.color||[];let T=0;g===!0&&(T=1),_===!0&&(T=2),d===!0&&(T=3);let R=o.attributes.position.count*T,A=1;R>t.maxTextureSize&&(A=Math.ceil(R/t.maxTextureSize),R=t.maxTextureSize);const b=new Float32Array(R*A*4*u),C=new Oh(b,R,A,u);C.type=Fn,C.needsUpdate=!0;const v=T*4;for(let D=0;D<u;D++){const k=p[D],O=E[D],X=x[D],V=R*A*4*D;for(let H=0;H<k.count;H++){const Y=H*v;g===!0&&(i.fromBufferAttribute(k,H),b[V+Y+0]=i.x,b[V+Y+1]=i.y,b[V+Y+2]=i.z,b[V+Y+3]=0),_===!0&&(i.fromBufferAttribute(O,H),b[V+Y+4]=i.x,b[V+Y+5]=i.y,b[V+Y+6]=i.z,b[V+Y+7]=0),d===!0&&(i.fromBufferAttribute(X,H),b[V+Y+8]=i.x,b[V+Y+9]=i.y,b[V+Y+10]=i.z,b[V+Y+11]=X.itemSize===4?i.w:1)}}f={count:u,texture:C,size:new Pt(R,A)},n.set(o,f),o.addEventListener("dispose",S)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",a.morphTexture,e);else{let g=0;for(let d=0;d<c.length;d++)g+=c[d];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(r,"morphTargetBaseInfluence",_),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(r,"morphTargetsTextureSize",f.size)}return{update:s}}function X_(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(i.get(u)!==c&&(t.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;i.get(f)!==c&&(f.update(),i.set(f,c))}return u}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class Yh extends Ne{constructor(t,e,n,i,s,a,o,l,c,h=pr){if(h!==pr&&h!==Er)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===pr&&(n=Ui),n===void 0&&h===Er&&(n=yr),super(null,i,s,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:nn,this.minFilter=l!==void 0?l:nn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const qh=new Ne,Ic=new Yh(1,1),Kh=new Oh,Zh=new Pd,jh=new Vh,Nc=[],Oc=[],Fc=new Float32Array(16),Bc=new Float32Array(9),zc=new Float32Array(4);function Ir(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=Nc[i];if(s===void 0&&(s=new Float32Array(i),Nc[i]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,r[a].toArray(s,o)}return s}function _e(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function ge(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function xa(r,t){let e=Oc[t];e===void 0&&(e=new Int32Array(t),Oc[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function Y_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function q_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(_e(e,t))return;r.uniform2fv(this.addr,t),ge(e,t)}}function K_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(_e(e,t))return;r.uniform3fv(this.addr,t),ge(e,t)}}function Z_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(_e(e,t))return;r.uniform4fv(this.addr,t),ge(e,t)}}function j_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(_e(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),ge(e,t)}else{if(_e(e,n))return;zc.set(n),r.uniformMatrix2fv(this.addr,!1,zc),ge(e,n)}}function $_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(_e(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),ge(e,t)}else{if(_e(e,n))return;Bc.set(n),r.uniformMatrix3fv(this.addr,!1,Bc),ge(e,n)}}function J_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(_e(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),ge(e,t)}else{if(_e(e,n))return;Fc.set(n),r.uniformMatrix4fv(this.addr,!1,Fc),ge(e,n)}}function Q_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function tg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(_e(e,t))return;r.uniform2iv(this.addr,t),ge(e,t)}}function eg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(_e(e,t))return;r.uniform3iv(this.addr,t),ge(e,t)}}function ng(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(_e(e,t))return;r.uniform4iv(this.addr,t),ge(e,t)}}function ig(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function rg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(_e(e,t))return;r.uniform2uiv(this.addr,t),ge(e,t)}}function sg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(_e(e,t))return;r.uniform3uiv(this.addr,t),ge(e,t)}}function ag(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(_e(e,t))return;r.uniform4uiv(this.addr,t),ge(e,t)}}function og(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(Ic.compareFunction=Uh,s=Ic):s=qh,e.setTexture2D(t||s,i)}function lg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||Zh,i)}function cg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||jh,i)}function hg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||Kh,i)}function ug(r){switch(r){case 5126:return Y_;case 35664:return q_;case 35665:return K_;case 35666:return Z_;case 35674:return j_;case 35675:return $_;case 35676:return J_;case 5124:case 35670:return Q_;case 35667:case 35671:return tg;case 35668:case 35672:return eg;case 35669:case 35673:return ng;case 5125:return ig;case 36294:return rg;case 36295:return sg;case 36296:return ag;case 35678:case 36198:case 36298:case 36306:case 35682:return og;case 35679:case 36299:case 36307:return lg;case 35680:case 36300:case 36308:case 36293:return cg;case 36289:case 36303:case 36311:case 36292:return hg}}function fg(r,t){r.uniform1fv(this.addr,t)}function dg(r,t){const e=Ir(t,this.size,2);r.uniform2fv(this.addr,e)}function pg(r,t){const e=Ir(t,this.size,3);r.uniform3fv(this.addr,e)}function mg(r,t){const e=Ir(t,this.size,4);r.uniform4fv(this.addr,e)}function _g(r,t){const e=Ir(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function gg(r,t){const e=Ir(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function vg(r,t){const e=Ir(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function xg(r,t){r.uniform1iv(this.addr,t)}function Mg(r,t){r.uniform2iv(this.addr,t)}function Sg(r,t){r.uniform3iv(this.addr,t)}function yg(r,t){r.uniform4iv(this.addr,t)}function Eg(r,t){r.uniform1uiv(this.addr,t)}function Tg(r,t){r.uniform2uiv(this.addr,t)}function bg(r,t){r.uniform3uiv(this.addr,t)}function Ag(r,t){r.uniform4uiv(this.addr,t)}function wg(r,t,e){const n=this.cache,i=t.length,s=xa(e,i);_e(n,s)||(r.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==i;++a)e.setTexture2D(t[a]||qh,s[a])}function Rg(r,t,e){const n=this.cache,i=t.length,s=xa(e,i);_e(n,s)||(r.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==i;++a)e.setTexture3D(t[a]||Zh,s[a])}function Cg(r,t,e){const n=this.cache,i=t.length,s=xa(e,i);_e(n,s)||(r.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==i;++a)e.setTextureCube(t[a]||jh,s[a])}function Pg(r,t,e){const n=this.cache,i=t.length,s=xa(e,i);_e(n,s)||(r.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==i;++a)e.setTexture2DArray(t[a]||Kh,s[a])}function Dg(r){switch(r){case 5126:return fg;case 35664:return dg;case 35665:return pg;case 35666:return mg;case 35674:return _g;case 35675:return gg;case 35676:return vg;case 5124:case 35670:return xg;case 35667:case 35671:return Mg;case 35668:case 35672:return Sg;case 35669:case 35673:return yg;case 5125:return Eg;case 36294:return Tg;case 36295:return bg;case 36296:return Ag;case 35678:case 36198:case 36298:case 36306:case 35682:return wg;case 35679:case 36299:case 36307:return Rg;case 35680:case 36300:case 36308:case 36293:return Cg;case 36289:case 36303:case 36311:case 36292:return Pg}}class Lg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=ug(e.type)}}class Ug{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Dg(e.type)}}class Ig{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(t,e[o.id],n)}}}const $a=/(\w+)(\])?(\[|\.)?/g;function kc(r,t){r.seq.push(t),r.map[t.id]=t}function Ng(r,t,e){const n=r.name,i=n.length;for($a.lastIndex=0;;){const s=$a.exec(n),a=$a.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){kc(e,c===void 0?new Lg(o,r,t):new Ug(o,r,t));break}else{let u=e.map[o];u===void 0&&(u=new Ig(o),kc(e,u)),e=u}}}class Ks{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),a=t.getUniformLocation(e,s.name);Ng(s,a,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const a=t[i];a.id in e&&n.push(a)}return n}}function Hc(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const Og=37297;let Fg=0;function Bg(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function zg(r){const t=Wt.getPrimaries(Wt.workingColorSpace),e=Wt.getPrimaries(r);let n;switch(t===e?n="":t===ia&&e===na?n="LinearDisplayP3ToLinearSRGB":t===na&&e===ia&&(n="LinearSRGBToLinearDisplayP3"),r){case hi:case ga:return[n,"LinearTransferOETF"];case _n:case pl:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function Gc(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),i=r.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+Bg(r.getShaderSource(t),a)}else return i}function kg(r,t){const e=zg(t);return`vec4 ${r}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Hg(r,t){let e;switch(t){case Hf:e="Linear";break;case Gf:e="Reinhard";break;case Vf:e="Cineon";break;case Wf:e="ACESFilmic";break;case Yf:e="AgX";break;case qf:e="Neutral";break;case Xf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Ns=new N;function Gg(){Wt.getLuminanceCoefficients(Ns);const r=Ns.x.toFixed(4),t=Ns.y.toFixed(4),e=Ns.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Vg(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Vr).join(`
`)}function Wg(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Xg(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:r.getAttribLocation(t,a),locationSize:o}}return e}function Vr(r){return r!==""}function Vc(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Wc(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Yg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Xo(r){return r.replace(Yg,Kg)}const qg=new Map;function Kg(r,t){let e=Lt[t];if(e===void 0){const n=qg.get(t);if(n!==void 0)e=Lt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Xo(e)}const Zg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Xc(r){return r.replace(Zg,jg)}function jg(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Yc(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}function $g(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Mh?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===df?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===In&&(t="SHADOWMAP_TYPE_VSM"),t}function Jg(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Mr:case Sr:t="ENVMAP_TYPE_CUBE";break;case _a:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Qg(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Sr:t="ENVMAP_MODE_REFRACTION";break}return t}function t0(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Sh:t="ENVMAP_BLENDING_MULTIPLY";break;case zf:t="ENVMAP_BLENDING_MIX";break;case kf:t="ENVMAP_BLENDING_ADD";break}return t}function e0(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function n0(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=$g(e),c=Jg(e),h=Qg(e),u=t0(e),f=e0(e),m=Vg(e),g=Wg(s),_=i.createProgram();let d,p,E=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const x=E+d+a,T=E+p+o,R=Hc(i,i.VERTEX_SHADER,x),A=Hc(i,i.FRAGMENT_SHADER,T);i.attachShader(_,R),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(D){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(R).trim(),X=i.getShaderInfoLog(A).trim();let V=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(V=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,R,A);else{const Y=Gc(i,R,"vertex"),G=Gc(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
*/var Ze={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Ar={duration:.5,overwrite:!1,delay:0},xl,Re,Jt,sn=1e8,jt=1/sn,Yo=Math.PI*2,tv=Yo/4,ev=0,tu=Math.sqrt,nv=Math.cos,iv=Math.sin,Se=function(t){return typeof t=="string"},se=function(t){return typeof t=="function"},Hn=function(t){return typeof t=="number"},Ml=function(t){return typeof t>"u"},wn=function(t){return typeof t=="object"},Oe=function(t){return t!==!1},Sl=function(){return typeof window<"u"},Gs=function(t){return se(t)||Se(t)},eu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Ce=Array.isArray,qo=/(?:-?\.?\d|\.)+/gi,nu=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,hr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,no=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,iu=/[+-]=-?[.\d]+/,ru=/[^,'"\[\]\s]+/gi,rv=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,te,gn,Ko,yl,je={},la={},su,au=function(t){return(la=Oi(t,je))&&ke},El=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},Qr=function(t,e){return!e&&console.warn(t)},ou=function(t,e){return t&&(je[t]=e)&&la&&(la[t]=e)||je},ts=function(){return 0},sv={suppressEvents:!0,isStart:!0,kill:!1},Zs={suppressEvents:!0,kill:!1},av={suppressEvents:!0},Tl={},ri=[],Zo={},lu,Xe={},io={},rh=30,js=[],bl="",Al=function(t){var e=t[0],n,i;if(wn(e)||se(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=js.length;i--&&!js[i].targetTest(e););n=js[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new Lu(t[i],n)))||t.splice(i,1);return t},Ci=function(t){return t._gsap||Al(an(t))[0]._gsap},cu=function(t,e,n){return(n=t[e])&&se(n)?t[e]():Ml(n)&&t.getAttribute&&t.getAttribute(e)||n},Fe=function(t,e){return(t=t.split(",")).forEach(e)||t},ae=function(t){return Math.round(t*1e5)/1e5||0},xe=function(t){return Math.round(t*1e7)/1e7||0},gr=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},ov=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},ca=function(){var t=ri.length,e=ri.slice(0),n,i;for(Zo={},ri.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},hu=function(t,e,n,i){ri.length&&!Re&&ca(),t.render(e,n,Re&&e<0&&(t._initted||t._startAt)),ri.length&&!Re&&ca()},uu=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(ru).length<2?e:Se(t)?t.trim():t},fu=function(t){return t},on=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},lv=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},Oi=function(t,e){for(var n in e)t[n]=e[n];return t},sh=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=wn(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},ha=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},Kr=function(t){var e=t.parent||te,n=t.keyframes?lv(Ce(t.keyframes)):on;if(Oe(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},cv=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},du=function(t,e,n,i,s){var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},Ma=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},li=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},Pi=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},hv=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},jo=function(t,e,n,i){return t._startAt&&(Re?t._startAt.revert(Zs):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},uv=function r(t){return!t||t._ts&&r(t.parent)},ah=function(t){return t._repeat?wr(t._tTime,t=t.duration()+t._rDelay)*t:0},wr=function(t,e){var n=Math.floor(t/=e);return t&&n===t?n-1:n},ua=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},Sa=function(t){return t._end=xe(t._start+(t._tDur/Math.abs(t._ts||t._rts||jt)||0))},ya=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=xe(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),Sa(t),n._dirty||Pi(n,t)),t},pu=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=ua(t.rawTime(),e),(!e._dur||hs(0,e.totalDuration(),n)-e._tTime>jt)&&e.render(n,!0)),Pi(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-jt}},Sn=function(t,e,n,i){return e.parent&&li(e),e._start=xe((Hn(n)?n:n||t!==te?tn(t,n,e):t._time)+e._delay),e._end=xe(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),du(t,e,"_first","_last",t._sort?"_start":0),$o(e)||(t._recent=e),i||pu(t,e),t._ts<0&&ya(t,t._tTime),t},mu=function(t,e){return(je.ScrollTrigger||El("scrollTrigger",e))&&je.ScrollTrigger.create(e,t)},_u=function(t,e,n,i,s){if(Rl(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!Re&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&lu!==Ye.frame)return ri.push(t),t._lazy=[s,i],1},fv=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},$o=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},dv=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&(!t._start&&fv(t)&&!(!t._initted&&$o(t))||(t._ts<0||t._dp._ts<0)&&!$o(t))?0:1,o=t._rDelay,l=0,c,h,u;if(o&&t._repeat&&(l=hs(0,t._tDur,e),h=wr(l,o),t._yoyo&&h&1&&(a=1-a),h!==wr(t._tTime,o)&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||Re||i||t._zTime===jt||!e&&t._zTime){if(!t._initted&&_u(t,e,i,n,l))return;for(u=t._zTime,t._zTime=e||(n?jt:0),n||(n=e&&!u),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,c=t._pt;c;)c.r(a,c.d),c=c._next;e<0&&jo(t,e,n,!0),t._onUpdate&&!n&&Ke(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&Ke(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&li(t,1),!n&&!Re&&(Ke(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},pv=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},Rr=function(t,e,n,i){var s=t._repeat,a=xe(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:xe(a*(s+1)+t._rDelay*s):a,o>0&&!i&&ya(t,t._tTime=t._tDur*o),t.parent&&Sa(t),n||Pi(t.parent,t),t},oh=function(t){return t instanceof Le?Pi(t):Rr(t,t._dur)},mv={_start:0,endTime:ts,totalDuration:ts},tn=function r(t,e,n){var i=t.labels,s=t._recent||mv,a=t.duration()>=sn?s.endTime(!1):t._dur,o,l,c;return Se(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),c&&n&&(l=l/100*(Ce(n)?n[0]:n).totalDuration()),o>1?r(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},Zr=function(t,e,n){var i=Hn(e[1]),s=(i?2:1)+(t<2?0:1),a=e[s],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Oe(l.vars.inherit)&&l.parent;a.immediateRender=Oe(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[s-1]}return new fe(e[0],a,e[s+1])},ui=function(t,e){return t||t===0?e(t):e},hs=function(t,e,n){return n<t?t:n>e?e:n},we=function(t,e){return!Se(t)||!(e=rv.exec(t))?"":e[1]},_v=function(t,e,n){return ui(n,function(i){return hs(t,e,i)})},Jo=[].slice,gu=function(t,e){return t&&wn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&wn(t[0]))&&!t.nodeType&&t!==gn},gv=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return Se(i)&&!e||gu(i,1)?(s=n).push.apply(s,an(i)):n.push(i)})||n},an=function(t,e,n){return Jt&&!e&&Jt.selector?Jt.selector(t):Se(t)&&!n&&(Ko||!Cr())?Jo.call((e||yl).querySelectorAll(t),0):Ce(t)?gv(t,n):gu(t)?Jo.call(t,0):t?[t]:[]},Qo=function(t){return t=an(t)[0]||Qr("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return an(e,n.querySelectorAll?n:n===t?Qr("Invalid scope")||yl.createElement("div"):t)}},vu=function(t){return t.sort(function(){return .5-Math.random()})},xu=function(t){if(se(t))return t;var e=wn(t)?t:{each:t},n=Di(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,h=i,u=i;return Se(i)?h=u={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(h=i[0],u=i[1]),function(f,m,g){var _=(g||e).length,d=a[_],p,E,x,T,R,A,b,C,v;if(!d){if(v=e.grid==="auto"?0:(e.grid||[1,sn])[1],!v){for(b=-sn;b<(b=g[v++].getBoundingClientRect().left)&&v<_;);v<_&&v--}for(d=a[_]=[],p=l?Math.min(v,_)*h-.5:i%v,E=v===sn?0:l?_*u/v-.5:i/v|0,b=0,C=sn,A=0;A<_;A++)x=A%v-p,T=E-(A/v|0),d[A]=R=c?Math.abs(c==="y"?T:x):tu(x*x+T*T),R>b&&(b=R),R<C&&(C=R);i==="random"&&vu(d),d.max=b-C,d.min=C,d.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(v>_?_-1:c?c==="y"?_/v:v:Math.max(v,_/v))||0)*(i==="edges"?-1:1),d.b=_<0?s-_:s,d.u=we(e.amount||e.each)||0,n=n&&_<0?Cu(n):n}return _=(d[f]-d.min)/d.max||0,xe(d.b+(n?n(_):_)*d.v)+d.u}},tl=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=xe(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(Hn(n)?0:we(n))}},Mu=function(t,e){var n=Ce(t),i,s;return!n&&wn(t)&&(i=n=t.radius||sn,t.values?(t=an(t.values),(s=!Hn(t[0]))&&(i*=i)):t=tl(t.increment)),ui(e,n?se(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=sn,h=0,u=t.length,f,m;u--;)s?(f=t[u].x-o,m=t[u].y-l,f=f*f+m*m):f=Math.abs(t[u]-o),f<c&&(c=f,h=u);return h=!i||c<=i?t[h]:a,s||h===a||Hn(a)?h:h+we(a)}:tl(t))},Su=function(t,e,n,i){return ui(Ce(t)?!e:n===!0?!!(n=0):!i,function(){return Ce(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},vv=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},xv=function(t,e){return function(n){return t(parseFloat(n))+(e||we(n))}},Mv=function(t,e,n){return Eu(t,e,0,1,n)},yu=function(t,e,n){return ui(n,function(i){return t[~~e(i)]})},Sv=function r(t,e,n){var i=e-t;return Ce(t)?yu(t,r(0,t.length),e):ui(n,function(s){return(i+(s-t)%i)%i+t})},yv=function r(t,e,n){var i=e-t,s=i*2;return Ce(t)?yu(t,r(0,t.length-1),e):ui(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},es=function(t){for(var e=0,n="",i,s,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",s=t.substr(i+7,a-i-7).match(o?ru:qo),n+=t.substr(e,i-e)+Su(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},Eu=function(t,e,n,i,s){var a=e-t,o=i-n;return ui(s,function(l){return n+((l-t)/a*o||0)})},Ev=function r(t,e,n,i){var s=isNaN(t+e)?0:function(m){return(1-m)*t+m*e};if(!s){var a=Se(t),o={},l,c,h,u,f;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(Ce(t)&&!Ce(e)){for(h=[],u=t.length,f=u-2,c=1;c<u;c++)h.push(r(t[c-1],t[c]));u--,s=function(g){g*=u;var _=Math.min(f,~~g);return h[_](g-_)},n=e}else i||(t=Oi(Ce(t)?[]:{},t));if(!h){for(l in e)wl.call(o,t,l,"get",e[l]);s=function(g){return Dl(g,o)||(a?t.p:t)}}}return ui(n,s)},lh=function(t,e,n){var i=t.labels,s=sn,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},Ke=function(t,e,n){var i=t.vars,s=i[e],a=Jt,o=t._ctx,l,c,h;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&ri.length&&ca(),o&&(Jt=o),h=l?s.apply(c,l):s.call(c),Jt=a,h},Wr=function(t){return li(t),t.scrollTrigger&&t.scrollTrigger.kill(!!Re),t.progress()<1&&Ke(t,"onInterrupt"),t},ur,Tu=[],bu=function(t){if(t)if(t=!t.name&&t.default||t,Sl()||t.headless){var e=t.name,n=se(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:ts,render:Dl,add:wl,kill:zv,modifier:Bv,rawVars:0},a={targetTest:0,get:0,getSetter:Pl,aliases:{},register:0};if(Cr(),t!==i){if(Xe[e])return;on(i,on(ha(t,s),a)),Oi(i.prototype,Oi(s,ha(t,a))),Xe[i.prop=e]=i,t.targetTest&&(js.push(i),Tl[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}ou(e,i),t.register&&t.register(ke,i,Be)}else Tu.push(t)},Zt=255,Xr={aqua:[0,Zt,Zt],lime:[0,Zt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Zt],navy:[0,0,128],white:[Zt,Zt,Zt],olive:[128,128,0],yellow:[Zt,Zt,0],orange:[Zt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Zt,0,0],pink:[Zt,192,203],cyan:[0,Zt,Zt],transparent:[Zt,Zt,Zt,0]},ro=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*Zt+.5|0},Au=function(t,e,n){var i=t?Hn(t)?[t>>16,t>>8&Zt,t&Zt]:0:Xr.black,s,a,o,l,c,h,u,f,m,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),Xr[t])i=Xr[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&Zt,i&Zt,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&Zt,t&Zt]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(qo),!e)l=+i[0]%360/360,c=+i[1]/100,h=+i[2]/100,a=h<=.5?h*(c+1):h+c-h*c,s=h*2-a,i.length>3&&(i[3]*=1),i[0]=ro(l+1/3,s,a),i[1]=ro(l,s,a),i[2]=ro(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(nu),n&&i.length<4&&(i[3]=1),i}else i=t.match(qo)||Xr.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/Zt,a=i[1]/Zt,o=i[2]/Zt,u=Math.max(s,a,o),f=Math.min(s,a,o),h=(u+f)/2,u===f?l=c=0:(m=u-f,c=h>.5?m/(2-u-f):m/(u+f),l=u===s?(a-o)/m+(a<o?6:0):u===a?(o-s)/m+2:(s-a)/m+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(h*100+.5)),n&&i.length<4&&(i[3]=1),i},wu=function(t){var e=[],n=[],i=-1;return t.split(si).forEach(function(s){var a=s.match(hr)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},ch=function(t,e,n){var i="",s=(t+i).match(si),a=e?"hsla(":"rgba(",o=0,l,c,h,u;if(!s)return t;if(s=s.map(function(f){return(f=Au(f,e,1))&&a+(e?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(h=wu(t),l=n.c,l.join(i)!==h.c.join(i)))for(c=t.replace(si,"1").split(hr),u=c.length-1;o<u;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(h.length?h:s.length?s:n).shift());if(!c)for(c=t.split(si),u=c.length-1;o<u;o++)i+=c[o]+s[o];return i+c[u]},si=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in Xr)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),Tv=/hsl[a]?\(/,Ru=function(t){var e=t.join(" "),n;if(si.lastIndex=0,si.test(e))return n=Tv.test(e),t[1]=ch(t[1],n),t[0]=ch(t[0],n,wu(t[1])),!0},ns,Ye=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,h,u,f,m,g=function _(d){var p=r()-i,E=d===!0,x,T,R,A;if((p>t||p<0)&&(n+=p-e),i+=p,R=i-n,x=R-a,(x>0||E)&&(A=++u.frame,f=R-u.time*1e3,u.time=R=R/1e3,a+=x+(x>=s?4:s-x),T=1),E||(l=c(_)),T)for(m=0;m<o.length;m++)o[m](R,f,A,d)};return u={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(d){return f/(1e3/(d||60))},wake:function(){su&&(!Ko&&Sl()&&(gn=Ko=window,yl=gn.document||{},je.gsap=ke,(gn.gsapVersions||(gn.gsapVersions=[])).push(ke.version),au(la||gn.GreenSockGlobals||!gn.gsap&&gn||{}),Tu.forEach(bu)),h=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&u.sleep(),c=h||function(d){return setTimeout(d,a-u.time*1e3+1|0)},ns=1,g(2))},sleep:function(){(h?cancelAnimationFrame:clearTimeout)(l),ns=0,c=ts},lagSmoothing:function(d,p){t=d||1/0,e=Math.min(p||33,t)},fps:function(d){s=1e3/(d||240),a=u.time*1e3+s},add:function(d,p,E){var x=p?function(T,R,A,b){d(T,R,A,b),u.remove(x)}:d;return u.remove(d),o[E?"unshift":"push"](x),Cr(),x},remove:function(d,p){~(p=o.indexOf(d))&&o.splice(p,1)&&m>=p&&m--},_listeners:o},u}(),Cr=function(){return!ns&&Ye.wake()},Ot={},bv=/^[\d.\-M][\d.\-,\s]/,Av=/["']/g,wv=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace(Av,"").trim():+c,i=l.substr(o+1).trim();return e},Rv=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},Cv=function(t){var e=(t+"").split("("),n=Ot[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[wv(e[1])]:Rv(t).split(",").map(uu)):Ot._CE&&bv.test(t)?Ot._CE("",t):n},Cu=function(t){return function(e){return 1-t(1-e)}},Pu=function r(t,e){for(var n=t._first,i;n;)n instanceof Le?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},Di=function(t,e){return t&&(se(t)?t:Ot[t]||Cv(t))||e},Hi=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return Fe(t,function(o){Ot[o]=je[o]=s,Ot[a=o.toLowerCase()]=n;for(var l in s)Ot[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Ot[o+"."+l]=s[l]}),s},Du=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},so=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/Yo*(Math.asin(1/i)||0),o=function(h){return h===1?1:i*Math.pow(2,-10*h)*iv((h-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:Du(o);return s=Yo/s,l.config=function(c,h){return r(t,c,h)},l},ao=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:Du(n);return i.config=function(s){return r(t,s)},i};Fe("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;Hi(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Ot.Linear.easeNone=Ot.none=Ot.Linear.easeIn;Hi("Elastic",so("in"),so("out"),so());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};Hi("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);Hi("Expo",function(r){return r?Math.pow(2,10*(r-1)):0});Hi("Circ",function(r){return-(tu(1-r*r)-1)});Hi("Sine",function(r){return r===1?1:-nv(r*tv)+1});Hi("Back",ao("in"),ao("out"),ao());Ot.SteppedEase=Ot.steps=je.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-jt;return function(o){return((i*hs(0,a,o)|0)+s)*n}}};Ar.ease=Ot["quad.out"];Fe("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return bl+=r+","+r+"Params,"});var Lu=function(t,e){this.id=ev++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:cu,this.set=e?e.getSetter:Pl},is=function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,Rr(this,+e.duration,1,1),this.data=e.data,Jt&&(this._ctx=Jt,Jt.data.push(this)),ns||Ye.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,Rr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(Cr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(ya(this,n),!s._dp||s.parent||pu(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Sn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===jt||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),hu(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+ah(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>0?1:0},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+ah(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?wr(this._tTime,s)+1:1},t.timeScale=function(n,i){if(!arguments.length)return this._rts===-jt?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?ua(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-jt?0:this._rts,this.totalTime(hs(-Math.abs(this._delay),this._tDur,s),i!==!1),Sa(this),hv(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Cr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==jt&&(this._tTime-=jt)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Sn(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(Oe(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?ua(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=av);var i=Re;return Re=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Re=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,oh(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,oh(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(tn(this,n),Oe(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Oe(i))},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-jt:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-jt,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-jt)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(s){var a=se(n)?n:fu,o=function(){var c=i.then;i.then=null,se(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){Wr(this)},r}();on(is.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-jt,_prom:0,_ps:!1,_rts:1});var Le=function(r){Qh(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Oe(n.sortChildren),te&&Sn(n.parent||te,Nn(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&mu(Nn(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return Zr(0,arguments,this),this},e.from=function(i,s,a){return Zr(1,arguments,this),this},e.fromTo=function(i,s,a,o){return Zr(2,arguments,this),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,Kr(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new fe(i,s,tn(this,a),1),this},e.call=function(i,s,a){return Sn(this,fe.delayedCall(0,i,s),a)},e.staggerTo=function(i,s,a,o,l,c,h){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=h,a.parent=this,new fe(i,a,tn(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,h){return a.runBackwards=1,Kr(a).immediateRender=Oe(a.immediateRender),this.staggerTo(i,s,a,o,l,c,h)},e.staggerFromTo=function(i,s,a,o,l,c,h,u){return o.startAt=a,Kr(o).immediateRender=Oe(o.immediateRender),this.staggerTo(i,s,o,l,c,h,u)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,h=i<=0?0:xe(i),u=this._zTime<0!=i<0&&(this._initted||!c),f,m,g,_,d,p,E,x,T,R,A,b;if(this!==te&&h>l&&i>=0&&(h=l),h!==this._tTime||a||u){if(o!==this._time&&c&&(h+=this._time-o,i+=this._time-o),f=h,T=this._start,x=this._ts,p=!x,u&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(A=this._yoyo,d=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(d*100+i,s,a);if(f=xe(h%d),h===l?(_=this._repeat,f=c):(_=~~(h/d),_&&_===h/d&&(f=c,_--),f>c&&(f=c)),R=wr(this._tTime,d),!o&&this._tTime&&R!==_&&this._tTime-R*d-this._dur<=0&&(R=_),A&&_&1&&(f=c-f,b=1),_!==R&&!this._lock){var C=A&&R&1,v=C===(A&&_&1);if(_<R&&(C=!C),o=C?0:h%c?c:h,this._lock=1,this.render(o||(b?0:xe(_*d)),s,!c)._lock=0,this._tTime=h,!s&&this.parent&&Ke(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),o&&o!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,v&&(this._lock=2,o=C?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!p)return this;Pu(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(E=pv(this,xe(o),xe(f)),E&&(h-=f-(f=E._start))),this._tTime=h,this._time=f,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&f&&!s&&!_&&(Ke(this,"onStart"),this._tTime!==h))return this;if(f>=o&&i>=0)for(m=this._first;m;){if(g=m._next,(m._act||f>=m._start)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(f-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(f-m._start)*m._ts,s,a),f!==this._time||!this._ts&&!p){E=0,g&&(h+=this._zTime=-jt);break}}m=g}else{m=this._last;for(var S=i<0?i:f;m;){if(g=m._prev,(m._act||S<=m._end)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(S-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(S-m._start)*m._ts,s,a||Re&&(m._initted||m._startAt)),f!==this._time||!this._ts&&!p){E=0,g&&(h+=this._zTime=S?-jt:jt);break}}m=g}}if(E&&!s&&(this.pause(),E.render(f>=o?0:-jt)._zTime=f>=o?1:-1,this._ts))return this._start=T,Sa(this),this.render(i,s,a);this._onUpdate&&!s&&Ke(this,"onUpdate",!0),(h===l&&this._tTime>=this.totalDuration()||!h&&o)&&(T===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(h===l&&this._ts>0||!h&&this._ts<0)&&li(this,1),!s&&!(i<0&&!o)&&(h||o||!l)&&(Ke(this,h===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(Hn(s)||(s=tn(this,s,i)),!(i instanceof is)){if(Ce(i))return i.forEach(function(o){return a.add(o,s)}),this;if(Se(i))return this.addLabel(i,s);if(se(i))i=fe.delayedCall(0,i);else return this}return this!==i?Sn(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-sn);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof fe?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return Se(i)?this.removeLabel(i):se(i)?this.killTweensOf(i):(Ma(this,i),i===this._recent&&(this._recent=this._last),Pi(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=xe(Ye.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=tn(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=fe.delayedCall(0,s||ts,a);return o.data="isPause",this._hasPause=1,Sn(this,o,tn(this,i))},e.removePause=function(i){var s=this._first;for(i=tn(this,i);s;)s._start===i&&s.data==="isPause"&&li(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)Qn!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=an(i),l=this._first,c=Hn(s),h;l;)l instanceof fe?ov(l._targets,o)&&(c?(!Qn||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(h=l.getTweensOf(o,s)).length&&a.push.apply(a,h),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=tn(a,i),l=s,c=l.startAt,h=l.onStart,u=l.onStartParams,f=l.immediateRender,m,g=fe.to(a,on({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||jt,onStart:function(){if(a.pause(),!m){var d=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==d&&Rr(g,d,0,1).render(g._time,!0,!0),m=1}h&&h.apply(g,u||[])}},s));return f?g.render(0):g},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,on({startAt:{time:tn(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),lh(this,tn(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),lh(this,tn(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+jt)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return Pi(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Pi(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=sn,c,h,u;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(u=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),h=o._start,h>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,Sn(a,o,h-o._delay,1)._lock=0):l=h,h<0&&o._ts&&(s-=h,(!u&&!a._dp||u&&u.smoothChildTiming)&&(a._start+=h/a._ts,a._time-=h,a._tTime-=h),a.shiftChildren(-h,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;Rr(a,a===te&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(te._ts&&(hu(te,ua(i,te)),lu=Ye.frame),Ye.frame>=rh){rh+=Ze.autoSleep||120;var s=te._first;if((!s||!s._ts)&&Ze.autoSleep&&Ye._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||Ye.sleep()}}},t}(is);on(Le.prototype,{_lock:0,_hasPause:0,_forcing:0});var Pv=function(t,e,n,i,s,a,o){var l=new Be(this._pt,t,e,0,1,Bu,null,s),c=0,h=0,u,f,m,g,_,d,p,E;for(l.b=n,l.e=i,n+="",i+="",(p=~i.indexOf("random("))&&(i=es(i)),a&&(E=[n,i],a(E,t,e),n=E[0],i=E[1]),f=n.match(no)||[];u=no.exec(i);)g=u[0],_=i.substring(c,u.index),m?m=(m+1)%5:_.substr(-5)==="rgba("&&(m=1),g!==f[h++]&&(d=parseFloat(f[h-1])||0,l._pt={_next:l._pt,p:_||h===1?_:",",s:d,c:g.charAt(1)==="="?gr(d,g)-d:parseFloat(g)-d,m:m&&m<4?Math.round:0},c=no.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(iu.test(i)||p)&&(l.e=0),this._pt=l,l},wl=function(t,e,n,i,s,a,o,l,c,h){se(i)&&(i=i(s||0,t,a));var u=t[e],f=n!=="get"?n:se(u)?c?t[e.indexOf("set")||!se(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():u,m=se(u)?c?Nv:Ou:Cl,g;if(Se(i)&&(~i.indexOf("random(")&&(i=es(i)),i.charAt(1)==="="&&(g=gr(f,i)+(we(f)||0),(g||g===0)&&(i=g))),!h||f!==i||el)return!isNaN(f*i)&&i!==""?(g=new Be(this._pt,t,e,+f||0,i-(f||0),typeof u=="boolean"?Fv:Fu,0,m),c&&(g.fp=c),o&&g.modifier(o,this,t),this._pt=g):(!u&&!(e in t)&&El(e,i),Pv.call(this,t,e,f,i,m,l||Ze.stringFilter,c))},Dv=function(t,e,n,i,s){if(se(t)&&(t=jr(t,s,e,n,i)),!wn(t)||t.style&&t.nodeType||Ce(t)||eu(t))return Se(t)?jr(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=jr(t[o],s,e,n,i);return a},Uu=function(t,e,n,i,s,a){var o,l,c,h;if(Xe[t]&&(o=new Xe[t]).init(s,o.rawVars?e[t]:Dv(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new Be(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==ur))for(c=n._ptLookup[n._targets.indexOf(s)],h=o._props.length;h--;)c[o._props[h]]=l;return o},Qn,el,Rl=function r(t,e,n){var i=t.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,h=i.runBackwards,u=i.yoyoEase,f=i.keyframes,m=i.autoRevert,g=t._dur,_=t._startAt,d=t._targets,p=t.parent,E=p&&p.data==="nested"?p.vars.targets:d,x=t._overwrite==="auto"&&!xl,T=t.timeline,R,A,b,C,v,S,D,k,O,X,V,H,Y;if(T&&(!f||!s)&&(s="none"),t._ease=Di(s,Ar.ease),t._yEase=u?Cu(Di(u===!0?s:u,Ar.ease)):0,u&&t._yoyo&&!t._repeat&&(u=t._yEase,t._yEase=t._ease,t._ease=u),t._from=!T&&!!i.runBackwards,!T||f&&!i.stagger){if(k=d[0]?Ci(d[0]).harness:0,H=k&&i[k.prop],R=ha(i,Tl),_&&(_._zTime<0&&_.progress(1),e<0&&h&&o&&!m?_.render(-1,!0):_.revert(h&&g?Zs:sv),_._lazy=0),a){if(li(t._startAt=fe.set(d,on({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!_&&Oe(l),startAt:null,delay:0,onUpdate:c&&function(){return Ke(t,"onUpdate")},stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Re||!o&&!m)&&t._startAt.revert(Zs),o&&g&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(h&&g&&!_){if(e&&(o=!1),b=on({overwrite:!1,data:"isFromStart",lazy:o&&!_&&Oe(l),immediateRender:o,stagger:0,parent:p},R),H&&(b[k.prop]=H),li(t._startAt=fe.set(d,b)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Re?t._startAt.revert(Zs):t._startAt.render(-1,!0)),t._zTime=e,!o)r(t._startAt,jt,jt);else if(!e)return}for(t._pt=t._ptCache=0,l=g&&Oe(l)||l&&!g,A=0;A<d.length;A++){if(v=d[A],D=v._gsap||Al(d)[A]._gsap,t._ptLookup[A]=X={},Zo[D.id]&&ri.length&&ca(),V=E===d?A:E.indexOf(v),k&&(O=new k).init(v,H||R,t,V,E)!==!1&&(t._pt=C=new Be(t._pt,v,O.name,0,1,O.render,O,0,O.priority),O._props.forEach(function(G){X[G]=C}),O.priority&&(S=1)),!k||H)for(b in R)Xe[b]&&(O=Uu(b,R,t,V,v,E))?O.priority&&(S=1):X[b]=C=wl.call(t,v,b,"get",R[b],V,E,0,i.stringFilter);t._op&&t._op[A]&&t.kill(v,t._op[A]),x&&t._pt&&(Qn=t,te.killTweensOf(v,X,t.globalTime(e)),Y=!t.parent,Qn=0),t._pt&&l&&(Zo[D.id]=1)}S&&zu(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!Y,f&&e<=0&&T.render(sn,!0,!0)},Lv=function(t,e,n,i,s,a,o,l){var c=(t._pt&&t._ptCache||(t._ptCache={}))[e],h,u,f,m;if(!c)for(c=t._ptCache[e]=[],f=t._ptLookup,m=t._targets.length;m--;){if(h=f[m][e],h&&h.d&&h.d._pt)for(h=h.d._pt;h&&h.p!==e&&h.fp!==e;)h=h._next;if(!h)return el=1,t.vars[e]="+=0",Rl(t,o),el=0,l?Qr(e+" not eligible for reset"):1;c.push(h)}for(m=c.length;m--;)u=c[m],h=u._pt||u,h.s=(i||i===0)&&!s?i:h.s+(i||0)+a*h.c,h.c=n-h.s,u.e&&(u.e=ae(n)+we(u.e)),u.b&&(u.b=h.s+we(u.b))},Uv=function(t,e){var n=t[0]?Ci(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=Oi({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},Iv=function(t,e,n,i){var s=e.ease||i||"power1.inOut",a,o;if(Ce(e))o=n[t]||(n[t]=[]),e.forEach(function(l,c){return o.push({t:c/(e.length-1)*100,v:l,e:s})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:s})},jr=function(t,e,n,i,s){return se(t)?t.call(e,n,i,s):Se(t)&&~t.indexOf("random(")?es(t):t},Iu=bl+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",Nu={};Fe(Iu+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return Nu[r]=1});var fe=function(r){Qh(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:Kr(i))||this;var l=o.vars,c=l.duration,h=l.delay,u=l.immediateRender,f=l.stagger,m=l.overwrite,g=l.keyframes,_=l.defaults,d=l.scrollTrigger,p=l.yoyoEase,E=i.parent||te,x=(Ce(n)||eu(n)?Hn(n[0]):"length"in i)?[n]:an(n),T,R,A,b,C,v,S,D;if(o._targets=x.length?Al(x):Qr("GSAP target "+n+" not found. https://gsap.com",!Ze.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=m,g||f||Gs(c)||Gs(h)){if(i=o.vars,T=o.timeline=new Le({data:"nested",defaults:_||{},targets:E&&E.data==="nested"?E.vars.targets:x}),T.kill(),T.parent=T._dp=Nn(o),T._start=0,f||Gs(c)||Gs(h)){if(b=x.length,S=f&&xu(f),wn(f))for(C in f)~Iu.indexOf(C)&&(D||(D={}),D[C]=f[C]);for(R=0;R<b;R++)A=ha(i,Nu),A.stagger=0,p&&(A.yoyoEase=p),D&&Oi(A,D),v=x[R],A.duration=+jr(c,Nn(o),R,v,x),A.delay=(+jr(h,Nn(o),R,v,x)||0)-o._delay,!f&&b===1&&A.delay&&(o._delay=h=A.delay,o._start+=h,A.delay=0),T.to(v,A,S?S(R,v,x):0),T._ease=Ot.none;T.duration()?c=h=0:o.timeline=0}else if(g){Kr(on(T.vars.defaults,{ease:"none"})),T._ease=Di(g.ease||i.ease||"none");var k=0,O,X,V;if(Ce(g))g.forEach(function(H){return T.to(x,H,">")}),T.duration();else{A={};for(C in g)C==="ease"||C==="easeEach"||Iv(C,g[C],A,g.easeEach);for(C in A)for(O=A[C].sort(function(H,Y){return H.t-Y.t}),k=0,R=0;R<O.length;R++)X=O[R],V={ease:X.e,duration:(X.t-(R?O[R-1].t:0))/100*c},V[C]=X.v,T.to(x,V,k),k+=V.duration;T.duration()<c&&T.to({},{duration:c-T.duration()})}}c||o.duration(c=T.duration())}else o.timeline=0;return m===!0&&!xl&&(Qn=Nn(o),te.killTweensOf(x),Qn=0),Sn(E,Nn(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(u||!c&&!g&&o._start===xe(E._time)&&Oe(u)&&uv(Nn(o))&&E.data!=="nested")&&(o._tTime=-jt,o.render(Math.max(0,-h)||0)),d&&mu(Nn(o),d),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,h=i<0,u=i>l-jt&&!h?l:i<jt?0:i,f,m,g,_,d,p,E,x,T;if(!c)dv(this,i,s,a);else if(u!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==h){if(f=u,x=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&h)return this.totalTime(_*100+i,s,a);if(f=xe(u%_),u===l?(g=this._repeat,f=c):(g=~~(u/_),g&&g===xe(u/_)&&(f=c,g--),f>c&&(f=c)),p=this._yoyo&&g&1,p&&(T=this._yEase,f=c-f),d=wr(this._tTime,_),f===o&&!a&&this._initted&&g===d)return this._tTime=u,this;g!==d&&(x&&this._yEase&&Pu(x,p),this.vars.repeatRefresh&&!p&&!this._lock&&this._time!==_&&this._initted&&(this._lock=a=1,this.render(xe(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(_u(this,h?i:f,a,s,u))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==d))return this;if(c!==this._dur)return this.render(i,s,a)}if(this._tTime=u,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=E=(T||this._ease)(f/c),this._from&&(this.ratio=E=1-E),f&&!o&&!s&&!g&&(Ke(this,"onStart"),this._tTime!==u))return this;for(m=this._pt;m;)m.r(E,m.d),m=m._next;x&&x.render(i<0?i:x._dur*x._ease(f/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(h&&jo(this,i,s,a),Ke(this,"onUpdate")),this._repeat&&g!==d&&this.vars.onRepeat&&!s&&this.parent&&Ke(this,"onRepeat"),(u===this._tDur||!u)&&this._tTime===u&&(h&&!this._onUpdate&&jo(this,i,!0,!0),(i||!c)&&(u===this._tDur&&this._ts>0||!u&&this._ts<0)&&li(this,1),!s&&!(h&&!o)&&(u||o||p)&&(Ke(this,u===l?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,a,o,l){ns||Ye.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),h;return this._initted||Rl(this,c),h=this._ease(c/this._dur),Lv(this,i,s,a,o,h,c,l)?this.resetTo(i,s,a,o,1):(ya(this,0),this.parent||du(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Wr(this):this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,Qn&&Qn.vars.overwrite!==!0)._first||Wr(this),this.parent&&a!==this.timeline.totalDuration()&&Rr(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?an(i):o,c=this._ptLookup,h=this._pt,u,f,m,g,_,d,p;if((!s||s==="all")&&cv(o,l))return s==="all"&&(this._pt=0),Wr(this);for(u=this._op=this._op||[],s!=="all"&&(Se(s)&&(_={},Fe(s,function(E){return _[E]=1}),s=_),s=Uv(o,s)),p=o.length;p--;)if(~l.indexOf(o[p])){f=c[p],s==="all"?(u[p]=s,g=f,m={}):(m=u[p]=u[p]||{},g=s);for(_ in g)d=f&&f[_],d&&((!("kill"in d.d)||d.d.kill(_)===!0)&&Ma(this,d,"_pt"),delete f[_]),m!=="all"&&(m[_]=1)}return this._initted&&!this._pt&&h&&Wr(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return Zr(1,arguments)},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return Zr(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return te.killTweensOf(i,s,a)},t}(is);on(fe.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Fe("staggerTo,staggerFrom,staggerFromTo",function(r){fe[r]=function(){var t=new Le,e=Jo.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var Cl=function(t,e,n){return t[e]=n},Ou=function(t,e,n){return t[e](n)},Nv=function(t,e,n,i){return t[e](i.fp,n)},Ov=function(t,e,n){return t.setAttribute(e,n)},Pl=function(t,e){return se(t[e])?Ou:Ml(t[e])&&t.setAttribute?Ov:Cl},Fu=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},Fv=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},Bu=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},Dl=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},Bv=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},zv=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?Ma(this,e,"_pt"):e.dep||(n=1),e=i;return!n},kv=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},zu=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},Be=function(){function r(e,n,i,s,a,o,l,c,h){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||Fu,this.d=l||this,this.set=c||Cl,this.pr=h||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=kv,this.m=n,this.mt=s,this.tween=i},r}();Fe(bl+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return Tl[r]=1});je.TweenMax=je.TweenLite=fe;je.TimelineLite=je.TimelineMax=Le;te=new Le({sortChildren:!1,defaults:Ar,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Ze.stringFilter=Ru;var Li=[],$s={},Hv=[],hh=0,Gv=0,oo=function(t){return($s[t]||Hv).map(function(e){return e()})},nl=function(){var t=Date.now(),e=[];t-hh>2&&(oo("matchMediaInit"),Li.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=gn.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&e.push(n))}),oo("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),hh=t,oo("matchMedia"))},ku=function(){function r(e,n){this.selector=n&&Qo(n),this.data=[],this._r=[],this.isReverted=!1,this.id=Gv++,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){se(n)&&(s=i,i=n,n=se);var a=this,o=function(){var c=Jt,h=a.selector,u;return c&&c!==a&&c.data.push(a),s&&(a.selector=Qo(s)),Jt=a,u=i.apply(a,arguments),se(u)&&a._r.push(u),Jt=c,a.selector=h,a.isReverted=!1,u};return a.last=o,n===se?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},t.ignore=function(n){var i=Jt;Jt=null,n(this),Jt=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof fe&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n?function(){for(var o=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(h){return o.splice(o.indexOf(h),1)}));for(o.map(function(h){return{g:h._dur||h._delay||h._sat&&!h._sat.vars.immediateRender?h.globalTime(0):-1/0,t:h}}).sort(function(h,u){return u.g-h.g||-1/0}).forEach(function(h){return h.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof Le?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof fe)&&c.revert&&c.revert(n);s._r.forEach(function(h){return h(n,s)}),s.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Li.length;a--;)Li[a].id===this.id&&Li.splice(a,1)},t.revert=function(n){this.kill(n||{})},r}(),Vv=function(){function r(e){this.contexts=[],this.scope=e,Jt&&Jt.data.push(this)}var t=r.prototype;return t.add=function(n,i,s){wn(n)||(n={matches:n});var a=new ku(0,s||this.scope),o=a.conditions={},l,c,h;Jt&&!a.selector&&(a.selector=Jt.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?h=1:(l=gn.matchMedia(n[c]),l&&(Li.indexOf(a)<0&&Li.push(a),(o[c]=l.matches)&&(h=1),l.addListener?l.addListener(nl):l.addEventListener("change",nl)));return h&&i(a,function(u){return a.add(null,u)}),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),fa={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return bu(i)})},timeline:function(t){return new Le(t)},getTweensOf:function(t,e){return te.getTweensOf(t,e)},getProperty:function(t,e,n,i){Se(t)&&(t=an(t)[0]);var s=Ci(t||{}).get,a=n?fu:uu;return n==="native"&&(n=""),t&&(e?a((Xe[e]&&Xe[e].get||s)(t,e,n,i)):function(o,l,c){return a((Xe[o]&&Xe[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=an(t),t.length>1){var i=t.map(function(h){return ke.quickSetter(h,e,n)}),s=i.length;return function(h){for(var u=s;u--;)i[u](h)}}t=t[0]||{};var a=Xe[e],o=Ci(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(h){var u=new a;ur._pt=0,u.init(t,n?h+n:h,ur,0,[t]),u.render(1,u),ur._pt&&Dl(1,ur)}:o.set(t,l);return a?c:function(h){return c(t,l,n?h+n:h,o,1)}},quickTo:function(t,e,n){var i,s=ke.to(t,Oi((i={},i[e]="+=0.1",i.paused=!0,i),n||{})),a=function(l,c,h){return s.resetTo(e,l,c,h)};return a.tween=s,a},isTweening:function(t){return te.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=Di(t.ease,Ar.ease)),sh(Ar,t||{})},config:function(t){return sh(Ze,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!Xe[o]&&!je[o]&&Qr(e+" effect requires "+o+" plugin.")}),io[e]=function(o,l,c){return n(an(o),on(l||{},s),c)},a&&(Le.prototype[e]=function(o,l,c){return this.add(io[e](o,wn(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Ot[t]=Di(e)},parseEase:function(t,e){return arguments.length?Di(t,e):Ot},getById:function(t){return te.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new Le(t),i,s;for(n.smoothChildTiming=Oe(t.smoothChildTiming),te.remove(n),n._dp=0,n._time=n._tTime=te._time,i=te._first;i;)s=i._next,(e||!(!i._dur&&i instanceof fe&&i.vars.onComplete===i._targets[0]))&&Sn(n,i,i._start-i._delay),i=s;return Sn(te,n,0),n},context:function(t,e){return t?new ku(t,e):Jt},matchMedia:function(t){return new Vv(t)},matchMediaRefresh:function(){return Li.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||nl()},addEventListener:function(t,e){var n=$s[t]||($s[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=$s[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:Sv,wrapYoyo:yv,distribute:xu,random:Su,snap:Mu,normalize:Mv,getUnit:we,clamp:_v,splitColor:Au,toArray:an,selector:Qo,mapRange:Eu,pipe:vv,unitize:xv,interpolate:Ev,shuffle:vu},install:au,effects:io,ticker:Ye,updateRoot:Le.updateRoot,plugins:Xe,globalTimeline:te,core:{PropTween:Be,globals:ou,Tween:fe,Timeline:Le,Animation:is,getCache:Ci,_removeLinkedListItem:Ma,reverting:function(){return Re},context:function(t){return t&&Jt&&(Jt.data.push(t),t._ctx=Jt),Jt},suppressOverwrites:function(t){return xl=t}}};Fe("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return fa[r]=fe[r]});Ye.add(Le.updateRoot);ur=fa.to({},{duration:0});var Wv=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},Xv=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=Wv(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},lo=function(t,e){return{name:t,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(Se(s)&&(l={},Fe(s,function(h){return l[h]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}Xv(o,s)}}}},ke=fa.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)Re?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},lo("roundProps",tl),lo("modifiers"),lo("snap",Mu))||fa;fe.version=Le.version=ke.version="3.12.5";su=1;Sl()&&Cr();Ot.Power0;Ot.Power1;Ot.Power2;Ot.Power3;Ot.Power4;Ot.Linear;Ot.Quad;Ot.Cubic;Ot.Quart;Ot.Quint;Ot.Strong;Ot.Elastic;Ot.Back;Ot.SteppedEase;Ot.Bounce;Ot.Sine;Ot.Expo;Ot.Circ;/*!
 * CSSPlugin 3.12.5
 * https://gsap.com
 *
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var uh,ti,vr,Ll,wi,fh,Ul,Yv=function(){return typeof window<"u"},Gn={},yi=180/Math.PI,xr=Math.PI/180,ar=Math.atan2,dh=1e8,Il=/([A-Z])/g,qv=/(left|right|width|margin|padding|x)/i,Kv=/[\s,\(]\S/,yn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},il=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Zv=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},jv=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},$v=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Hu=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Gu=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},Jv=function(t,e,n){return t.style[e]=n},Qv=function(t,e,n){return t.style.setProperty(e,n)},tx=function(t,e,n){return t._gsap[e]=n},ex=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},nx=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},ix=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},ee="transform",ze=ee+"Origin",rx=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in Gn&&s){if(this.tfm=this.tfm||{},t!=="transform")t=yn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=On(i,o)}):this.tfm[t]=a.x?a[t]:On(i,t),t===ze&&(this.tfm.zOrigin=a.zOrigin);else return yn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(ee)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(ze,e,"")),t=ee}(s||e)&&this.props.push(t,e,s[t])},Vu=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},sx=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Il,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=Ul(),(!s||!s.isStart)&&!n[ee]&&(Vu(n),i.zOrigin&&n[ze]&&(n[ze]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Wu=function(t,e){var n={target:t,props:[],revert:sx,save:rx};return t._gsap||ke.core.getCache(t),e&&e.split(",").forEach(function(i){return n.save(i)}),n},Xu,rl=function(t,e){var n=ti.createElementNS?ti.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):ti.createElement(t);return n&&n.style?n:ti.createElement(t)},bn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Il,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Pr(e)||e,1)||""},ph="O,Moz,ms,Ms,Webkit".split(","),Pr=function(t,e,n){var i=e||wi,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(ph[a]+t in s););return a<0?null:(a===3?"ms":a>=0?ph[a]:"")+t},sl=function(){Yv()&&window.document&&(uh=window,ti=uh.document,vr=ti.documentElement,wi=rl("div")||{style:{}},rl("div"),ee=Pr(ee),ze=ee+"Origin",wi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Xu=!!Pr("perspective"),Ul=ke.core.reverting,Ll=1)},co=function r(t){var e=rl("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(vr.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),vr.removeChild(e),this.style.cssText=s,a},mh=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Yu=function(t){var e;try{e=t.getBBox()}catch{e=co.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===co||(e=co.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+mh(t,["x","cx","x1"])||0,y:+mh(t,["y","cy","y1"])||0,width:0,height:0}:e},qu=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Yu(t))},Fi=function(t,e){if(e){var n=t.style,i;e in Gn&&e!==ze&&(e=ee),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Il,"-$1").toLowerCase())):n.removeAttribute(e)}},ei=function(t,e,n,i,s,a){var o=new Be(t._pt,e,n,0,1,a?Gu:Hu);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},_h={deg:1,rad:1,turn:1},ax={grid:1,flex:1},ci=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=wi.style,l=qv.test(e),c=t.tagName.toLowerCase()==="svg",h=(c?"client":"offset")+(l?"Width":"Height"),u=100,f=i==="px",m=i==="%",g,_,d,p;if(i===a||!s||_h[i]||_h[a])return s;if(a!=="px"&&!f&&(s=r(t,e,n,"px")),p=t.getCTM&&qu(t),(m||a==="%")&&(Gn[e]||~e.indexOf("adius")))return g=p?t.getBBox()[l?"width":"height"]:t[h],ae(m?s/g*u:s/100*g);if(o[l?"width":"height"]=u+(f?a:i),_=~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,p&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===ti||!_.appendChild)&&(_=ti.body),d=_._gsap,d&&m&&d.width&&l&&d.time===Ye.time&&!d.uncache)return ae(s/d.width*u);if(m&&(e==="height"||e==="width")){var E=t.style[e];t.style[e]=u+i,g=t[h],E?t.style[e]=E:Fi(t,e)}else(m||a==="%")&&!ax[bn(_,"display")]&&(o.position=bn(t,"position")),_===t&&(o.position="static"),_.appendChild(wi),g=wi[h],_.removeChild(wi),o.position="absolute";return l&&m&&(d=Ci(_),d.time=Ye.time,d.width=_[h]),ae(f?g*s/u:g&&s?u/g*s:0)},On=function(t,e,n,i){var s;return Ll||sl(),e in yn&&e!=="transform"&&(e=yn[e],~e.indexOf(",")&&(e=e.split(",")[0])),Gn[e]&&e!=="transform"?(s=ss(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:pa(bn(t,ze))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=da[e]&&da[e](t,e,n)||bn(t,e)||cu(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ci(t,e,s,n)+n:s},ox=function(t,e,n,i){if(!n||n==="none"){var s=Pr(e,t,1),a=s&&bn(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=bn(t,"borderTopColor"))}var o=new Be(this._pt,t.style,e,0,1,Bu),l=0,c=0,h,u,f,m,g,_,d,p,E,x,T,R;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(_=t.style[e],t.style[e]=i,i=bn(t,e)||i,_?t.style[e]=_:Fi(t,e)),h=[n,i],Ru(h),n=h[0],i=h[1],f=n.match(hr)||[],R=i.match(hr)||[],R.length){for(;u=hr.exec(i);)d=u[0],E=i.substring(l,u.index),g?g=(g+1)%5:(E.substr(-5)==="rgba("||E.substr(-5)==="hsla(")&&(g=1),d!==(_=f[c++]||"")&&(m=parseFloat(_)||0,T=_.substr((m+"").length),d.charAt(1)==="="&&(d=gr(m,d)+T),p=parseFloat(d),x=d.substr((p+"").length),l=hr.lastIndex-x.length,x||(x=x||Ze.units[e]||T,l===i.length&&(i+=x,o.e+=x)),T!==x&&(m=ci(t,e,_,x)||0),o._pt={_next:o._pt,p:E||c===1?E:",",s:m,c:p-m,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?Gu:Hu;return iu.test(i)&&(o.e=0),this._pt=o,o},gh={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},lx=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=gh[n]||n,e[1]=gh[i]||i,e.join(" ")},cx=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Gn[o]&&(l=1,o=o==="transformOrigin"?ze:ee),Fi(n,o);l&&(Fi(n,ee),a&&(a.svg&&n.removeAttribute("transform"),ss(n,1),a.uncache=1,Vu(i)))}},da={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Be(t._pt,e,n,0,0,cx);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},rs=[1,0,0,1,0,0],Ku={},Zu=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},vh=function(t){var e=bn(t,ee);return Zu(e)?rs:e.substr(7).match(nu).map(ae)},Nl=function(t,e){var n=t._gsap||Ci(t),i=t.style,s=vh(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?rs:s):(s===rs&&!t.offsetParent&&t!==vr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(c=1,o=t.nextElementSibling,vr.appendChild(t)),s=vh(t),l?i.display=l:Fi(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):vr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},al=function(t,e,n,i,s,a){var o=t._gsap,l=s||Nl(t,!0),c=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,f=o.yOffset||0,m=l[0],g=l[1],_=l[2],d=l[3],p=l[4],E=l[5],x=e.split(" "),T=parseFloat(x[0])||0,R=parseFloat(x[1])||0,A,b,C,v;n?l!==rs&&(b=m*d-g*_)&&(C=T*(d/b)+R*(-_/b)+(_*E-d*p)/b,v=T*(-g/b)+R*(m/b)-(m*E-g*p)/b,T=C,R=v):(A=Yu(t),T=A.x+(~x[0].indexOf("%")?T/100*A.width:T),R=A.y+(~(x[1]||x[0]).indexOf("%")?R/100*A.height:R)),i||i!==!1&&o.smooth?(p=T-c,E=R-h,o.xOffset=u+(p*m+E*_)-p,o.yOffset=f+(p*g+E*d)-E):o.xOffset=o.yOffset=0,o.xOrigin=T,o.yOrigin=R,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[ze]="0px 0px",a&&(ei(a,o,"xOrigin",c,T),ei(a,o,"yOrigin",h,R),ei(a,o,"xOffset",u,o.xOffset),ei(a,o,"yOffset",f,o.yOffset)),t.setAttribute("data-svg-origin",T+" "+R)},ss=function(t,e){var n=t._gsap||new Lu(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=bn(t,ze)||"0",h,u,f,m,g,_,d,p,E,x,T,R,A,b,C,v,S,D,k,O,X,V,H,Y,G,st,at,ut,wt,zt,W,J;return h=u=f=_=d=p=E=x=T=0,m=g=1,n.svg=!!(t.getCTM&&qu(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[ee]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[ee]!=="none"?l[ee]:"")),i.scale=i.rotate=i.translate="none"),b=Nl(t,n.svg),n.svg&&(n.uncache?(G=t.getBBox(),c=n.xOrigin-G.x+"px "+(n.yOrigin-G.y)+"px",Y=""):Y=!e&&t.getAttribute("data-svg-origin"),al(t,Y||c,!!Y||n.originIsAbsolute,n.smooth!==!1,b)),R=n.xOrigin||0,A=n.yOrigin||0,b!==rs&&(D=b[0],k=b[1],O=b[2],X=b[3],h=V=b[4],u=H=b[5],b.length===6?(m=Math.sqrt(D*D+k*k),g=Math.sqrt(X*X+O*O),_=D||k?ar(k,D)*yi:0,E=O||X?ar(O,X)*yi+_:0,E&&(g*=Math.abs(Math.cos(E*xr))),n.svg&&(h-=R-(R*D+A*O),u-=A-(R*k+A*X))):(J=b[6],zt=b[7],at=b[8],ut=b[9],wt=b[10],W=b[11],h=b[12],u=b[13],f=b[14],C=ar(J,wt),d=C*yi,C&&(v=Math.cos(-C),S=Math.sin(-C),Y=V*v+at*S,G=H*v+ut*S,st=J*v+wt*S,at=V*-S+at*v,ut=H*-S+ut*v,wt=J*-S+wt*v,W=zt*-S+W*v,V=Y,H=G,J=st),C=ar(-O,wt),p=C*yi,C&&(v=Math.cos(-C),S=Math.sin(-C),Y=D*v-at*S,G=k*v-ut*S,st=O*v-wt*S,W=X*S+W*v,D=Y,k=G,O=st),C=ar(k,D),_=C*yi,C&&(v=Math.cos(C),S=Math.sin(C),Y=D*v+k*S,G=V*v+H*S,k=k*v-D*S,H=H*v-V*S,D=Y,V=G),d&&Math.abs(d)+Math.abs(_)>359.9&&(d=_=0,p=180-p),m=ae(Math.sqrt(D*D+k*k+O*O)),g=ae(Math.sqrt(H*H+J*J)),C=ar(V,H),E=Math.abs(C)>2e-4?C*yi:0,T=W?1/(W<0?-W:W):0),n.svg&&(Y=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Zu(bn(t,ee)),Y&&t.setAttribute("transform",Y))),Math.abs(E)>90&&Math.abs(E)<270&&(s?(m*=-1,E+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,E+=E<=0?180:-180)),e=e||n.uncache,n.x=h-((n.xPercent=h&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-h)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-u)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=ae(m),n.scaleY=ae(g),n.rotation=ae(_)+o,n.rotationX=ae(d)+o,n.rotationY=ae(p)+o,n.skewX=E+o,n.skewY=x+o,n.transformPerspective=T+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[ze]=pa(c)),n.xOffset=n.yOffset=0,n.force3D=Ze.force3D,n.renderTransform=n.svg?ux:Xu?ju:hx,n.uncache=0,n},pa=function(t){return(t=t.split(" "))[0]+" "+t[1]},ho=function(t,e,n){var i=we(e);return ae(parseFloat(e)+parseFloat(ci(t,"x",n+"px",i)))+i},hx=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,ju(t,e)},xi="0deg",Gr="0px",Mi=") ",ju=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,h=n.rotationY,u=n.rotationX,f=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,d=n.transformPerspective,p=n.force3D,E=n.target,x=n.zOrigin,T="",R=p==="auto"&&t&&t!==1||p===!0;if(x&&(u!==xi||h!==xi)){var A=parseFloat(h)*xr,b=Math.sin(A),C=Math.cos(A),v;A=parseFloat(u)*xr,v=Math.cos(A),a=ho(E,a,b*v*-x),o=ho(E,o,-Math.sin(A)*-x),l=ho(E,l,C*v*-x+x)}d!==Gr&&(T+="perspective("+d+Mi),(i||s)&&(T+="translate("+i+"%, "+s+"%) "),(R||a!==Gr||o!==Gr||l!==Gr)&&(T+=l!==Gr||R?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Mi),c!==xi&&(T+="rotate("+c+Mi),h!==xi&&(T+="rotateY("+h+Mi),u!==xi&&(T+="rotateX("+u+Mi),(f!==xi||m!==xi)&&(T+="skew("+f+", "+m+Mi),(g!==1||_!==1)&&(T+="scale("+g+", "+_+Mi),E.style[ee]=T||"translate(0, 0)"},ux=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,h=n.skewY,u=n.scaleX,f=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,d=n.xOffset,p=n.yOffset,E=n.forceCSS,x=parseFloat(a),T=parseFloat(o),R,A,b,C,v;l=parseFloat(l),c=parseFloat(c),h=parseFloat(h),h&&(h=parseFloat(h),c+=h,l+=h),l||c?(l*=xr,c*=xr,R=Math.cos(l)*u,A=Math.sin(l)*u,b=Math.sin(l-c)*-f,C=Math.cos(l-c)*f,c&&(h*=xr,v=Math.tan(c-h),v=Math.sqrt(1+v*v),b*=v,C*=v,h&&(v=Math.tan(h),v=Math.sqrt(1+v*v),R*=v,A*=v)),R=ae(R),A=ae(A),b=ae(b),C=ae(C)):(R=u,C=f,A=b=0),(x&&!~(a+"").indexOf("px")||T&&!~(o+"").indexOf("px"))&&(x=ci(m,"x",a,"px"),T=ci(m,"y",o,"px")),(g||_||d||p)&&(x=ae(x+g-(g*R+_*b)+d),T=ae(T+_-(g*A+_*C)+p)),(i||s)&&(v=m.getBBox(),x=ae(x+i/100*v.width),T=ae(T+s/100*v.height)),v="matrix("+R+","+A+","+b+","+C+","+x+","+T+")",m.setAttribute("transform",v),E&&(m.style[ee]=v)},fx=function(t,e,n,i,s){var a=360,o=Se(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?yi:1),c=l-i,h=i+c+"deg",u,f;return o&&(u=s.split("_")[1],u==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),u==="cw"&&c<0?c=(c+a*dh)%a-~~(c/a)*a:u==="ccw"&&c>0&&(c=(c-a*dh)%a-~~(c/a)*a)),t._pt=f=new Be(t._pt,e,n,i,c,Zv),f.e=h,f.u="deg",t._props.push(n),f},xh=function(t,e){for(var n in e)t[n]=e[n];return t},dx=function(t,e,n){var i=xh({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,h,u,f,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[ee]=e,o=ss(n,1),Fi(n,ee),n.setAttribute("transform",c)):(c=getComputedStyle(n)[ee],a[ee]=e,o=ss(n,1),a[ee]=c);for(l in Gn)c=i[l],h=o[l],c!==h&&s.indexOf(l)<0&&(m=we(c),g=we(h),u=m!==g?ci(n,l,c,g):parseFloat(c),f=parseFloat(h),t._pt=new Be(t._pt,o,l,u,f-u,il),t._pt.u=g||0,t._props.push(l));xh(o,i)};Fe("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});da[t>1?"border"+r:r]=function(o,l,c,h,u){var f,m;if(arguments.length<4)return f=a.map(function(g){return On(o,g,c)}),m=f.join(" "),m.split(f[0]).length===5?f[0]:m;f=(h+"").split(" "),m={},a.forEach(function(g,_){return m[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,m,u)}});var $u={name:"css",register:sl,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,h,u,f,m,g,_,d,p,E,x,T,R,A,b,C;Ll||sl(),this.styles=this.styles||Wu(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(h=e[_],!(Xe[_]&&Uu(_,e,n,i,t,s)))){if(m=typeof h,g=da[_],m==="function"&&(h=h.call(n,i,t,s),m=typeof h),m==="string"&&~h.indexOf("random(")&&(h=es(h)),g)g(this,t,_,h,n)&&(b=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),h+="",si.lastIndex=0,si.test(c)||(d=we(c),p=we(h)),p?d!==p&&(c=ci(t,_,c,p)+p):d&&(h+=d),this.add(o,"setProperty",c,h,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],Se(c)&&~c.indexOf("random(")&&(c=es(c)),we(c+"")||c==="auto"||(c+=Ze.units[_]||we(On(t,_))||""),(c+"").charAt(1)==="="&&(c=On(t,_))):c=On(t,_),f=parseFloat(c),E=m==="string"&&h.charAt(1)==="="&&h.substr(0,2),E&&(h=h.substr(2)),u=parseFloat(h),_ in yn&&(_==="autoAlpha"&&(f===1&&On(t,"visibility")==="hidden"&&u&&(f=0),C.push("visibility",0,o.visibility),ei(this,o,"visibility",f?"inherit":"hidden",u?"inherit":"hidden",!u)),_!=="scale"&&_!=="transform"&&(_=yn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in Gn,x){if(this.styles.save(_),T||(R=t._gsap,R.renderTransform&&!e.parseTransform||ss(t,e.parseTransform),A=e.smoothOrigin!==!1&&R.smooth,T=this._pt=new Be(this._pt,o,ee,0,1,R.renderTransform,R,0,-1),T.dep=1),_==="scale")this._pt=new Be(this._pt,R,"scaleY",R.scaleY,(E?gr(R.scaleY,E+u):u)-R.scaleY||0,il),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(ze,0,o[ze]),h=lx(h),R.svg?al(t,h,0,A,0,this):(p=parseFloat(h.split(" ")[2])||0,p!==R.zOrigin&&ei(this,R,"zOrigin",R.zOrigin,p),ei(this,o,_,pa(c),pa(h)));continue}else if(_==="svgOrigin"){al(t,h,1,A,0,this);continue}else if(_ in Ku){fx(this,R,_,f,E?gr(f,E+h):h);continue}else if(_==="smoothOrigin"){ei(this,R,"smooth",R.smooth,h);continue}else if(_==="force3D"){R[_]=h;continue}else if(_==="transform"){dx(this,h,t);continue}}else _ in o||(_=Pr(_)||_);if(x||(u||u===0)&&(f||f===0)&&!Kv.test(h)&&_ in o)d=(c+"").substr((f+"").length),u||(u=0),p=we(h)||(_ in Ze.units?Ze.units[_]:d),d!==p&&(f=ci(t,_,c,p)),this._pt=new Be(this._pt,x?R:o,_,f,(E?gr(f,E+u):u)-f,!x&&(p==="px"||_==="zIndex")&&e.autoRound!==!1?$v:il),this._pt.u=p||0,d!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=jv);else if(_ in o)ox.call(this,t,_,c,E?E+h:h);else if(_ in t)this.add(t,_,c||t[_],E?E+h:h,i,s);else if(_!=="parseTransform"){El(_,h);continue}x||(_ in o?C.push(_,0,o[_]):C.push(_,1,c||t[_])),a.push(_)}}b&&zu(this)},render:function(t,e){if(e.tween._time||!Ul())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:On,aliases:yn,getSetter:function(t,e,n){var i=yn[e];return i&&i.indexOf(",")<0&&(e=i),e in Gn&&e!==ze&&(t._gsap.x||On(t,"x"))?n&&fh===n?e==="scale"?ex:tx:(fh=n||{})&&(e==="scale"?nx:ix):t.style&&!Ml(t.style[e])?Jv:~e.indexOf("-")?Qv:Pl(t,e)},core:{_removeProperty:Fi,_getMatrix:Nl}};ke.utils.checkPrefix=Pr;ke.core.getStyleSaver=Wu;(function(r,t,e,n){var i=Fe(r+","+t+","+e,function(s){Gn[s]=1});Fe(t,function(s){Ze.units[s]="deg",Ku[s]=1}),yn[i[13]]=r+","+t,Fe(n,function(s){var a=s.split(":");yn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Fe("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ze.units[r]="px"});ke.registerPlugin($u);var Bi=ke.registerPlugin($u)||ke;Bi.core.Tween;const px=6,uo=5,us=2,An=3,xn={width:window.innerWidth,height:window.innerHeight},as=new en(75,xn.width/xn.height,.1,1e3);as.position.z=px;const mx=new Lr(1,1,1,uo,uo,uo),_x=new Tr({color:"#444444",wireframe:!0}),Ju=new qe(mx,_x),Qu=new N0;Ju.position.y=.5;const gx=new Ur(5,6),vx=new Tr({color:"#009688",side:Mn}),tf=new qe(gx,vx);tf.position.z=-.52;function Nr(){const r=new Ur(1,1),t=new Tr({color:"#fffae2"}),e=new Tr({color:"#a3ffd7"}),n=new qe(r,t),i=new qe(r,e);i.rotation.y=Math.PI;const s=new B0(r),a=new $h({color:"#000000"}),o=new F0(s,a),l=new rn;return l.add(n),l.add(i),l.add(o),l}const ef=Nr();ef.position.set(-.5,0,0);const Ol=new pe;Ol.add(ef);Bi.to(Ol.rotation,{delay:us,duration:An,x:0,y:Math.PI/2,z:0});const Fl=new rn;Fl.add(Ol);Fl.position.set(-.51,.5,-.51);const nf=Nr();nf.position.set(0,.5,0);const Bl=new pe;Bl.add(nf);Bi.to(Bl.rotation,{delay:us+An,duration:An,x:Math.PI/2,y:0,z:0});const zl=new rn;zl.add(Bl);zl.position.set(0,1.01,-.51);const rf=Nr();rf.position.set(.5,0,0);const kl=new pe;kl.add(rf);Bi.to(kl.rotation,{delay:us+An*2,duration:An,x:0,y:-Math.PI/2,z:0});const Hl=new rn;Hl.add(kl);Hl.position.set(.51,.5,-.51);const sf=Nr();sf.position.set(0,-.5,0);const Gl=new pe;Gl.add(sf);Bi.to(Gl.rotation,{delay:us+An*3,duration:An,x:-Math.PI/2,y:0,z:0});const Vl=new rn;Vl.add(Gl);Vl.position.set(0,-.01,-.51);const ma=Nr();ma.position.set(0,-1.5,0);const Js=new pe,Qs=new rn,Wl=new pe;Wl.add(ma);Bi.to(Wl.rotation,{delay:us+An*3,duration:An,x:-Math.PI/2,y:0,z:0,onComplete:()=>{Js.add(ma),ma.position.set(0,-.5,0),Bi.to(Js.rotation,{duration:An,x:-Math.PI/2,y:0,z:0}),Qs.add(Js),Qs.rotation.x=-Math.PI/2,Qs.position.set(0,-.01,.51)}});const Xl=new rn;Xl.add(Wl);Xl.position.set(0,-.01,-.51);const Yl=Nr();Yl.position.z=-.51;Yl.position.y=.5;const $e=new rn;$e.add(Ju);$e.add(tf);$e.add(Fl);$e.add(zl);$e.add(Hl);$e.add(Vl);$e.add(Xl);$e.add(Yl);$e.add(Js);$e.add(Qs);Qu.add($e);$e.rotation.x=-Math.PI/2.5;$e.rotation.z=Math.PI/7;const zi=new I0({antialias:!0});zi.setPixelRatio(Math.min(window.devicePixelRatio,2));zi.setSize(xn.width,xn.height);const Ri=zi.domElement;Ri.classList="webgl";document.body.appendChild(Ri);const af=new H0(as,Ri);af.enableDamping=!0;zi.setAnimationLoop(()=>{af.update(),zi.render(Qu,as)});window.addEventListener("resize",()=>{xn.width=window.innerWidth,xn.height=window.innerHeight,as.aspect=xn.width/xn.height,as.updateProjectionMatrix(),zi.setSize(xn.width,xn.height),zi.setPixelRatio(Math.min(window.devicePixelRatio,2))});window.addEventListener("dblclick",()=>{document.fullscreenElement||document.webkitFullscreenElement?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():Ri.requestFullscreen?Ri.requestFullscreen():Ri.webkitRequestFullscreen&&Ri.webkitRequestFullscreen()});
//# sourceMappingURL=index-C_w_wi-0.js.map
