...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function pa(){return new ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Cs(),fragmentShader:`
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function ma(){return new ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Cs(),fragmentShader:`
